...
#   DEPENDS:=@PCI_SUPPORT @TARGET_loongarch64 +kmod-lib-crc32c +kmod-ptp +kmod-libphy +kmod-mdio-devres
...
#   DEPENDS:=@TARGET_loongarch64 +kmod-stmmac-core
...
#   DEPENDS:=@TARGET_loongarch64 +kmod-tg3 +kmod-gpio-button-hotplug +kmod-leds-gpio \
#     +kmod-usb-ledtrig-usbport +PACKAGE_kmod-meraki-mx100:nu801 +kmod-itco-wdt \
#     +kmod-leds-uleds
#   KCONFIG:=CONFIG_MERAKI_MX100
#   FILES:=$(LINUX_DIR)/drivers/platform/loongarch/meraki-mx100.ko
